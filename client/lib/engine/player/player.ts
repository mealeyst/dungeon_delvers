import { TransformNode, ShadowGenerator, Scene, Mesh, UniversalCamera, ArcRotateCamera, Vector3, Quaternion, Ray, DeepImmutableObject, AbstractMesh } from "@babylonjs/core";
...
export class Player extends TransformNode {
  ...
  private _updateFromControls(): void {
    ...
    this.mesh.rotationQuaternion = Quaternion.Slerp(this.mesh.rotationQuaternion as DeepImmutableObject<Quaternion>, targ, 10 * this._deltaTime);
  }
