...
export class Player extends TransformNode {
  public camera: any // TODO: change this type to NOT be any
  public scene: Scene
  private _input
  ...
  private _updateFromControls(): void {
    ...
    this.mesh.rotationQuaternion = Quaternion.Slerp(
      this.mesh.rotationQuaternion as Quaternion, // TODO:investigate this type assertion
      targ,
      10 * this._deltaTime,
    )
  }
  ...
  private _floorRaycast(
    ...
    if (pick && pick.hit) {
      return pick.pickedPoint as Vector3 // TODO: Investigate this type assertion
    } else {
      return Vector3.Zero()
    }
  }
