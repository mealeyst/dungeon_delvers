...
class Sky extends core_1.TransformNode {
    constructor(name, scene, assets, options) {
        var _a, _b, _c, _d, _e;
        super(name, scene);
        ...
        this._inclination =
            ((_b = options === null || options === void 0 ? void 0 : options.sun) === null || _b === void 0 ? void 0 : _b.inclination) || (defualtSkyOptions === null || defualtSkyOptions === void 0 ? void 0 : defualtSkyOptions.sun.inclination);
        this._luminance =
            ((_c = options === null || options === void 0 ? void 0 : options.sky) === null || _c === void 0 ? void 0 : _c.luminance) || (defualtSkyOptions === null || defualtSkyOptions === void 0 ? void 0 : defualtSkyOptions.sky.luminance);
        ...
        this._turbidity =
            ((_e = options === null || options === void 0 ? void 0 : options.sky) === null || _e === void 0 ? void 0 : _e.turbidity) || (defualtSkyOptions === null || defualtSkyOptions === void 0 ? void 0 : defualtSkyOptions.sky.turbidity);
        ...
        this._starbox = core_1.MeshBuilder.CreateBox("starBox", { size: 1000.0 }, scene);
        this._starbox.parent = this;
        this._starMaterial = null;
        if (assets.starboxTexture !== null) {
            this._starMaterial = new standardMaterial_1.StandardMaterial("starMaterial", scene);
            this._starMaterial.reflectionTexture = assets.starboxTexture;
            this._starMaterial.reflectionTexture.coordinatesMode =
                core_1.Texture.SKYBOX_MODE;
            this._starMaterial.backFaceCulling = false;
            this._starMaterial.diffuseColor = new core_1.Color3(0, 0, 0);
            this._starMaterial.specularColor = new core_1.Color3(0, 0, 0);
            this._starMaterial.disableLighting = false;
            this._starbox.material = this._starMaterial;
        }
        this._skybox = core_1.MeshBuilder.CreateBox("skyBox", { size: 999.9 }, scene);
